 ...
 */
function crafted_theme_enqueue_assets(): void {
	// Fonts
	wp_enqueue_style(
		'google-fonts',
...
function display_svg_in_media_library(): void {
	echo '
    <style>
...
function crafted_disable_plugin_installation(): void {
...
function crafted_hide_plugin_menus(): void {
...
function crafted_disable_plugin_actions(): void {
...
function crafted_composer_plugin_notice(): void {
...
function crafted_hide_plugin_update_notifications(): void {
